  ...
  if (isset($_POST['submit'])) {
    ...
    if ($query->rowCount() == 0) {
      ...
      if (!in_array($extension, $allowed_extensions)) {
        echo "<script>alert('Formato incorrecto de imagen, favor intentar con las siguientes extensiones jpg / jpeg/ png /gif format allowed');</script>";
      } else {
        $image = md5($image) . time() . $extension;
        move_uploaded_file($_FILES["image"]["tmp_name"], "images/" . $image);
        $sql = "insert into tblstudent(StudentName,StudentEmail,StudentClass,Género,DOB,StuID,FatherName,MotherName,ContactNumber,AltenateNumber,Address,UserName,Password,Image)values(:stuname,:stuemail,:stuclass,:gender,:dob,:stuid,:fname,:mname,:connum,:altconnum,:address,:uname,:password,:image)";
      ...
      echo "<script>alert('Usuario o ID de Estudiante ya Existe, favor validar');</script>";
    }
  }
?>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form class="forms-sample row" method="post" enctype="multipart/form-data">
                  ...
                  <h3 class="col-md-12">Información de Acceso</h3>
                  <div class="form-group col-md-6">
