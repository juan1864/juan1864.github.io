...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $eid = $_GET['editid'];
    $sql = "update tblstudent set StudentName=:stuname,StudentEmail=:stuemail,StudentClass=:stuclass,Género=:gender,DOB=:dob,StuID=:stuid,FatherName=:fname,MotherName=:mname,ContactNumber=:connum,AltenateNumber=:altconnum,Address=:address where ID=:eid";
                    ...
                    foreach ($results as $row) {               ?>
                      ...
                      <div class="form-group">
                        ...
                        <select name="stuclass" class="form-control" required='true'>
                          <option value="<?php echo htmlentities($row->StudentClass); ?>"><?php echo htmlentities($row->ClassName); ?> <?php echo htmlentities($row->Sección); ?></option>
                          <?php
                          ...
                          ?>
                            <option value="<?php echo htmlentities($row1->ClassName); ?><?php echo htmlentities($row1->Sección); ?>"><?php echo htmlentities($row1->ClassName); ?> <?php echo htmlentities($row1->Sección); ?></option>
                          <?php } ?>
                        </select>
                      </div>
                      <div class="form-group">
                        ...
                        <select name="gender" value="" class="form-control" required='true'>
                          <option value="<?php echo htmlentities($row->Género); ?>"><?php echo htmlentities($row->Género); ?></option>
