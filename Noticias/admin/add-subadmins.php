            ...
            <div class="content">
               <div class="container">
                  <div class="row">
                     <div class="col-xs-12">
                        <div class="page-title-box">
                           <h4 class="page-title">Agregar subadministrador</h4>
                           <ol class="breadcrumb p-0 m-0">
                              <li>
                                 <a href="#">Administrador</a>
                              </li>
                              <li>
                                 <a href="#">Subadmininistrador </a>
                              </li>
                              <li class="active">
                  ...
                  <div class="row">
                     <div class="col-sm-12">
                        <div class="card-box">
                           <h4 class="m-t-0 header-title"><b>Agregar subadministrador </b></h4>
                           <hr />
                           <div class="row">
                              <form class="row" name="addsuadmin" method="post">
                                 <div class="form-group col-md-6">
                                    <label for="exampleInputusername">Nombre de usuario (iniciar sesión)</label>
