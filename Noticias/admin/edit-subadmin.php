<?php
   ...
   $email=$_POST['emailid'];
   $query=mysqli_query($con,"Update  tbladmin set AdminEmaillId='$email'  where userType=0 && id='$aid'");
   if($query)
   {
            ...
            <div class="content">
               <div class="container">
                  <div class="row">
                     <div class="col-xs-12">
                        <div class="page-title-box">
                           <h4 class="page-title">Editar Subadmin</h4>
                  ...
                  <div class="row">
                     <div class="col-sm-12">
                        <div class="card-box">
                           <h4 class="m-t-0 header-title"><b>Editar Subadmin </b></h4>
                           <hr />
                           <div class="row">
                              <div class="col-sm-6">
                           ...
                           <div class="row">
                              <form class="row" name="suadmin" method="post">
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <div class="">
                                       <input type="text" class="form-control" value="<?php echo htmlentities($row['AdminEmaillId']);?>" name="emailid" required>
                                    </div>
                                 </div>
                                 <div class="form-group col-md-6">
                                 ...
                                 <div class="form-group col-md-6">
                                    <label class="control-label">Actualizar fecha</label>
